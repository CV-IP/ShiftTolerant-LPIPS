...
# loss_fn = lpips.LPIPS(net='alex', variant="vanilla") # Trained from scratch

##### ST-LPIPS (STv0.0)
# loss_fn = lpips.LPIPS(net='alex', variant="antialiased")
loss_fn = lpips.LPIPS(net='alex', variant="shift_tolerant")
