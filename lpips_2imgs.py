...
# lpips_metric = lpips.LPIPS(net='alex', variant="vanilla")
## Distance: 0.818
#####

##### ST-LPIPS (STv0.0)
# lpips_metric = lpips.LPIPS(net='alex', variant="antialiased")
## Distance: 0.682

lpips_metric = lpips.LPIPS(net="alex", variant="shift_tolerant")
## Distance: 0.778

# lpips_metric = lpips.LPIPS(net="vgg", variant="shift_tolerant")
## Distance: 0.652
#####
...
# Compute distance
dist01 = lpips_metric.forward(img0,img1)
